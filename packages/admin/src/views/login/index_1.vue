...
const $Method = {
    ...
    async sendCode() {
        ...
        try {
            await $Http('/core/sendSmsCode', { phone: $Data.loginForm.phone.phone });
    ...
    async handleLogin() {
        ...
        try {
            const res = await $Http('/core/admin/login', formData);
    ...
    async handleRegister() {
        ...
        try {
            await $Http('/core/admin/register', $Data.registerForm);
